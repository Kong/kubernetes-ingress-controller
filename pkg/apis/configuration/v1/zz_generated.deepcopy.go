...
func (in *ArbitraryObj) DeepCopyInto(out *ArbitraryObj) {
	*out = *in
	if in.ValueArray != nil {
		in, out := &in.ValueArray, &out.ValueArray
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ValueFrom != nil {
		in, out := &in.ValueFrom, &out.ValueFrom
		*out = new(ArbitraryObjSource)
		(*in).DeepCopyInto(*out)
	}
	if in.ValueFromArray != nil {
		in, out := &in.ValueFromArray, &out.ValueFromArray
		*out = make([]*ArbitraryObjSource, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(ArbitraryObjSource)
	...
	if in.ValueNested != nil {
		in, out := &in.ValueNested, &out.ValueNested
		*out = new(apiextensionsv1.JSON)
		(*in).DeepCopyInto(*out)
	}
	if in.ValueNestedArray != nil {
		in, out := &in.ValueNestedArray, &out.ValueNestedArray
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArbitraryObj.
func (in *ArbitraryObj) DeepCopy() *ArbitraryObj {
	if in == nil {
		return nil
	}
	out := new(ArbitraryObj)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ArbitraryObjSource) DeepCopyInto(out *ArbitraryObjSource) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArbitraryObjSource.
func (in *ArbitraryObjSource) DeepCopy() *ArbitraryObjSource {
	if in == nil {
		return nil
	}
	out := new(ArbitraryObjSource)
