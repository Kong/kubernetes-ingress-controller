...
# FIXME: investigate `go-kong` changes that would allow us to remove `allowDangerousTypes=true`.
...
test.integration:
	go test -tags=integration_tests -v ./test/integration/...
...
debug: generate fmt vet manifests
	KONG_EXTERNAL_CONTROLLER=true KONG_CONFIGURATION_NAMESPACE=kong-system dlv debug ./main.go
