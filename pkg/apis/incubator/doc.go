// Package incubator contains API Schema definitions for the incubator.ingress-controller.acceldata.io API group.
...
// They're unlikely to be promoted to the `configuration.acceldata.io` group, but if they do,
