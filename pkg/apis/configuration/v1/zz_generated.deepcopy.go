...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KongPluginOrdering) DeepCopyInto(out *KongPluginOrdering) {
	*out = *in
	if in.Before != nil {
		in, out := &in.Before, &out.Before
		*out = make(KongPluginOrderingPhase, len(*in))
		for key, val := range *in {
			var outVal []string
			if val == nil {
				(*out)[key] = nil
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KongPluginOrdering.
func (in *KongPluginOrdering) DeepCopy() *KongPluginOrdering {
	if in == nil {
		return nil
	}
	out := new(KongPluginOrdering)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in KongPluginOrderingPhase) DeepCopyInto(out *KongPluginOrderingPhase) {
	{
		in := &in
		*out = make(KongPluginOrderingPhase, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KongPluginOrderingPhase.
func (in KongPluginOrderingPhase) DeepCopy() KongPluginOrderingPhase {
	if in == nil {
		return nil
	}
	out := new(KongPluginOrderingPhase)
	in.DeepCopyInto(out)
	return *out
}
