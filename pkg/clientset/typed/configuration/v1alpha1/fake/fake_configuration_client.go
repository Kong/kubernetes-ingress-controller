...
func (c *FakeConfigurationV1alpha1) KongCustomEntityDefinitions(namespace string) v1alpha1.KongCustomEntityDefinitionInterface {
	return &FakeKongCustomEntityDefinitions{c, namespace}
}
