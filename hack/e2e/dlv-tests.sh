...
GOFLAGS="-tags=integration_tests" KONG_TEST_CLUSTER="gke:${CLUSTER_NAME}" dlv test ./test/integration/... -- --test.parallel "${NCPU}" --test.timeout 60m --test.v --test.run TestIngressClassNameSpec
