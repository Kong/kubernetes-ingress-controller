...
type ConfigurationV1alpha1Interface interface {
	...
	KongCustomEntityDefinitionsGetter
}
...
func (c *ConfigurationV1alpha1Client) KongCustomEntityDefinitions(namespace string) KongCustomEntityDefinitionInterface {
	return newKongCustomEntityDefinitions(c, namespace)
}
