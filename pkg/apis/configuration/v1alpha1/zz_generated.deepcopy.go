...
func (in *ConfigSourcePatch) DeepCopyInto(out *ConfigSourcePatch) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigSourcePatch.
func (in *ConfigSourcePatch) DeepCopy() *ConfigSourcePatch {
	if in == nil {
		return nil
	}
	out := new(ConfigSourcePatch)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KongCustomEntitySpec) DeepCopyInto(out *KongCustomEntitySpec) {
	*out = *in
	...
	if in.Patches != nil {
		...
		*out = make([]ConfigSourcePatch, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
