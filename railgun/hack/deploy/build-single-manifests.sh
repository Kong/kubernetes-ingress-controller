...
kustomize build $STAGE_DIR/base > ./config/single/all-in-one-dbless.yaml
kustomize build $STAGE_DIR/variants/postgres > ./config/single/all-in-one-postgres.yaml
kustomize build $STAGE_DIR/variants/enterprise > ./config/single/all-in-one-enterprise-dbless.yaml
kustomize build $STAGE_DIR/variants/enterprise-postgres > ./config/single/all-in-one-enterprise-postgres.yaml
