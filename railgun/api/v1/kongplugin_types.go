...
// KongPluginSpec defines the desired state of KongPlugin
type KongPluginSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Foo is an example field of KongPlugin. Edit kongplugin_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// KongPluginStatus defines the observed state of KongPlugin
...
type KongPlugin struct {
	...
	Spec   KongPluginSpec   `json:"spec,omitempty"`
