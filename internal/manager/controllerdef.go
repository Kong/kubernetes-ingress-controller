	...
	controllers := []ControllerDef{
		...
		// ---------------------------------------------------------------------------
		{
			...
			Controller: &crds.DynamicController{
				...
				Controllers: []crds.Controller{
					&gateway.ReferenceGrantReconciler{
						Client:           mgr.GetClient(),
