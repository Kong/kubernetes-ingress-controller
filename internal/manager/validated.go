...
func NewValidatedValue[T any](variable *T, constructor func(string) (T, error)) ValidatedValue[T] {
...
func NewValidatedValueWithDefault[T any](variable *T, constructor func(string) (T, error), value T) ValidatedValue[T] {
	*variable = value
	return ValidatedValue[T]{
		constructor: constructor,
		variable:    variable,
