...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KongLicenseParentStatus) DeepCopyInto(out *KongLicenseParentStatus) {
	*out = *in
	in.ControllerRef.DeepCopyInto(&out.ControllerRef)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KongLicenseParentStatus.
func (in *KongLicenseParentStatus) DeepCopy() *KongLicenseParentStatus {
	if in == nil {
		return nil
	}
	out := new(KongLicenseParentStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KongLicenseStatus) DeepCopyInto(out *KongLicenseStatus) {
	*out = *in
	if in.KongLicenseParentStatuses != nil {
		in, out := &in.KongLicenseParentStatuses, &out.KongLicenseParentStatuses
		*out = make([]KongLicenseParentStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
