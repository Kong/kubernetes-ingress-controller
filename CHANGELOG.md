...
- Generate a distinct Kong route for each match when its parent `HTTPRoute` rule
  ...
  NOTE: This would change the name of the name of generate routes from the affected
  `HTTPRoute` rules containing the filters.
...
- Do not fill plugin config auto fields. This prevents errors when KIC would send
  null plugin config fields for required fields, when they were also marked as `auto`
  which causes them to be generated by Kong.
  [#8003](https://github.com/Kong/kubernetes-ingress-controller/pull/8003)
- Bump go.opentelemetry.io/otel packages to 1.43.
  [#7976](https://github.com/Kong/kubernetes-ingress-controller/pull/7976)
...
- Do not fill plugin config auto fields. This prevents errors when KIC would send
  null plugin config fields for required fields, when they were also marked as `auto`
  which causes them to be generated by Kong.
  [#8004](https://github.com/Kong/kubernetes-ingress-controller/pull/8004)
- Bump go.opentelemetry.io/otel packages to 1.43.
  [#7976](https://github.com/Kong/kubernetes-ingress-controller/pull/7976)
  [#7997](https://github.com/Kong/kubernetes-ingress-controller/pull/7997)
