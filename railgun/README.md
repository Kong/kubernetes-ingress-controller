**NOTE**: What you're seeing in this directory is the [re-architecture][kep3] of the Kong Kubernetes Ingress Controller (KIC) which will be promoted to main as part of the [KIC 2.0 Milestone][milestone-12]. Don't use this yet! If you have questions, check in with us in the [#kong channel on Kubernetes slack][slack]!
