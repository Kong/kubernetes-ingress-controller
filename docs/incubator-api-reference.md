...
## Packages
- [incubator.ingress-controller.acceldata.io/v1alpha1](#incubatoringress-controllerkonghqcomv1alpha1)


## incubator.ingress-controller.acceldata.io/v1alpha1

Package v1alpha1 contains API Schema definitions for the incubator.ingress-controller.acceldata.io v1alpha1 API group.
...
| Field | Description |
| --- | --- |
| `apiVersion` _string_ | `incubator.ingress-controller.acceldata.io/v1alpha1`
